...
import { startSession, stopSession, exportBackup } from './lib/engine';
...
export default function App() {
  ...
  useEffect(() => { document.title = `Habla | ${['practice', 'roleplay'].includes(section) ? 'Practice' : routes.find(r => r.id === section)?.label || (section === 'settings' ? 'Preferences' : 'Our approach')}`; }, [section]);
